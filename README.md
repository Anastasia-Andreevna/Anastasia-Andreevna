...
|------------------|----------|------------|--------|
| [Анализ эффективности маркетплейса](https://github.com/Anastasia-Andreevna/Marketplace-performance-analysis) | Анализ ключевых метрик, retention и PMF бразильского маркетплейса. Приоритизация гипотез для роста прибыли. | Python, Pandas, Seaborn, Когортный анализ, ICE-фреймворк | [GitHub](https://github.com/Anastasia-Andreevna/Marketplace-performance-analysis) | 🟢 Завершён (в планах расширение анализа) |
